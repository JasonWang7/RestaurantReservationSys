...
$query = "CREATE OR REPLACE VIEW view_reservation_restaurant AS (select reservation.reservationid,reservation.userId,reservation.numguest,reservation.note,reservation.invitationList,reservation.dinningtime,reservation.email,reservation.phone as userphone, restaurant.restaurantname,restaurant.address,restaurant.phone from restaurant inner join reservation on restaurant.restaurantid =reservation.restaurantid )";
$result = mysql_query($query);
